...
export const authorityHubPathways: AuthorityHubPathway[] = [
  {
    ...
    symptomLookup: [
      ...
      { label: "Laminate gap repair", guideSlug: "how-to-fix-laminate-floor-separation", note: "Likely cause: open lock, damaged edge, moisture, or support issue. Urgency: inspect before forcing closed. Next step: choose close, reopen, replace, or investigate." },
  ...
  },
  {
    ...
    symptomLookup: [
      ...
      { label: "Fix laminate separation", guideSlug: "laminate-floor-separation-repair-guide", note: "Likely cause: cause-dependent repair. Urgency: inspect before gluing or filling. Next step: decide whether to close, lift rows, or replace boards." },
