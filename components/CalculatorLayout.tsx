...
export function CalculatorLayout({ title, intro, flooringSystem, children, formula, notes }: CalculatorLayoutProps) {
  return (
    <div className="grid min-w-0 gap-5 lg:grid-cols-[minmax(0,1fr)_340px] lg:items-start">
      <section className="min-w-0 rounded-lg border border-line bg-white p-4 shadow-sm" aria-label={`${title} inputs`}>
      ...
      <aside className="min-w-0 space-y-3.5">
        <section className="rounded-lg border border-line bg-white p-3.5 shadow-sm">
