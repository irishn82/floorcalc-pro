      ...
      <div className="mt-3 grid gap-2 sm:grid-cols-2">
        {links.map((link) => (
          <Link
            key={link.href}
            href={link.href}
            className="rounded-md border border-line bg-field p-2.5 text-sm font-bold text-slate-800 transition hover:border-accent-100 hover:bg-white hover:text-accent-700"
          >
            {link.label}
