      ...
      <div className="flex flex-1 flex-col gap-3 p-5">
        ...
        <div className="mt-auto flex flex-col items-start gap-2 pt-2 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link
            ...
            className={`inline-flex shrink-0 items-center gap-1 text-sm font-bold transition-colors ${isDark ? "text-accent-400 hover:text-accent-300" : "text-accent-600 hover:text-accent-700"}`}
          >
            Read
